...
set_property PULLUP true [get_ports kdata]
...
#set_property PACKAGE_PIN L1 [get_ports {keys[3]}]
#set_property PACKAGE_PIN P1 [get_ports {keys[2]}]
#set_property PACKAGE_PIN N3 [get_ports {keys[1]}]
#set_property PACKAGE_PIN P3 [get_ports {keys[0]}]
##set_property PACKAGE_PIN V14 [get_ports {datacur[7]}]
##set_property PACKAGE_PIN U14 [get_ports {datacur[6]}]
##set_property PACKAGE_PIN U15 [get_ports {datacur[5]}]
##set_property PACKAGE_PIN W18 [get_ports {datacur[4]}]
##set_property PACKAGE_PIN V19 [get_ports {datacur[3]}]
##set_property PACKAGE_PIN U16 [get_ports {datacur[0]}]
##set_property PACKAGE_PIN E19 [get_ports {datacur[1]}]
##set_property PACKAGE_PIN U19 [get_ports {datacur[2]}]
##set_property IOSTANDARD LVCMOS33 [get_ports {datacur[7]}]
##set_property IOSTANDARD LVCMOS33 [get_ports {datacur[6]}]
##set_property IOSTANDARD LVCMOS33 [get_ports {datacur[5]}]
##set_property IOSTANDARD LVCMOS33 [get_ports {datacur[4]}]
##set_property IOSTANDARD LVCMOS33 [get_ports {datacur[3]}]
##set_property IOSTANDARD LVCMOS33 [get_ports {datacur[2]}]
##set_property IOSTANDARD LVCMOS33 [get_ports {datacur[1]}]
##set_property IOSTANDARD LVCMOS33 [get_ports {datacur[0]}]
...
set_property IOSTANDARD LVCMOS33 [get_ports fire_1]
set_property IOSTANDARD LVCMOS33 [get_ports fire_2]
